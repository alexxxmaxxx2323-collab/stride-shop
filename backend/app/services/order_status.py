...
# Человеко-понятное пояснение при ВХОДЕ в статус — для уведомления покупателю.
# Не у каждого статуса есть смысл слать письмо (pending — стартовый, его покупатель
# уже видел в сводке заказа), поэтому здесь только «событийные» переходы.
STATUS_CUSTOMER_NOTE: dict[str, str] = {
    "assembling": "Мы начали собирать ваш заказ.",
    "shipped": "Заказ передан в службу доставки.",
    "in_transit": "Заказ в пути к вам.",
    "ready_for_pickup": "Заказ готов к выдаче — заберите его в выбранном пункте выдачи.",
    "delivered": "Заказ доставлен. Спасибо за покупку! 🙌",
    "delivery_failed": "Возникла заминка с доставкой — мы свяжемся с вами для уточнения.",
    "cancelled": "Заказ отменён. Списанные баллы возвращены на ваш счёт.",
    "returned": "По заказу оформлен возврат. Деньги и баллы вернутся в ближайшее время.",
}
